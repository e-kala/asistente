...
document.body.onload = e => {
	...
	if (!start){
		if (alma_config !== undefined){		
			if (alma_config[1].caducidad !== undefined){ //Uso de caducidad segun configuracion 
		...
		if (document.getElementsByClassName("fot")[0] !== undefined && document.getElementsByClassName("fot")[0] !== null){
			if (time_config !== undefined){ //Solo si la caducidad esta programada / definida arranca el intervalo
